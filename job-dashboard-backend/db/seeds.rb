...
Job.create(company:"Flatiron School", title:"Software Engineering Coach", status:"watching", dream_job: false, description:"The goal of any teacher or coach is to drive outcomes. We are looking for people who LOVE TEACHING. We make it a mission to seek out teachers who can infect, infuse and inspire with passion, wisdom, positivity, and humor. They show students how to love what they do, and how to better love who they are.", source:"Flatiron Website", url:"https://wework.wd1.myworkdayjobs.com/en-US/FlatironSchool/job/Chicago-IL-United-States-of-America/Coach--Software-Engineering_JR-0033810", user: alex)
...
Task.create(activity:"Submit application", user:alex, job_id: 1, due_by:DateTime.new(2019,07,20))
Task.create(activity:"Thank you note", user:alex, job_id: 1,due_by:DateTime.new(2019,07,21))
Task.create(activity:"Follow up e-mail", user:alex, job_id: 1,due_by:DateTime.new(2019,07,02))